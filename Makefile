...
.PHONY: smoke test coverage release clean test-local-pg start-test-postgres stop-test-postgres reset-test-postgres
...
start-test-postgres:
	@bash "scripts/start_test_postgres.sh" >/dev/null
